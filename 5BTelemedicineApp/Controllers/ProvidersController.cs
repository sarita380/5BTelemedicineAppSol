...
namespace _5BTelemedicineApp.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LastName,Specialty,Phone,Email")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LastName,Specialty,Phone,Email")] Provider provider)
        {
            if (id != provider.Id)
            {
                return NotFound();
