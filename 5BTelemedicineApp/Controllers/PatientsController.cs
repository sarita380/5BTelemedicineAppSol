...
namespace _5BTelemedicineApp.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LastName,DOB,Age,Phone,Email")] Patients patients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LastName,DOB,Age,Phone,Email")] Patients patients)
        {
            if (id != patients.Id)
            {
                return NotFound();
